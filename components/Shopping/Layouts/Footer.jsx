...
function Footer() {
  return (
    ...
    <div className="bg-gradient-to-b bg-black self-center items-center justify-center flex flex-box">
      <div className="container  px-6 space-y-8 text-gray-400 md:px-12 lg:px-20">
        <div>
          <div className="mb-6 gap-6 items-center justify-between py-6 sm:flex md:mb-16 md:py-0 md:space-y-6">
            <img width={100} height={42} src="/test/logo.jpg" alt="logo tailus" className="w-32" />
